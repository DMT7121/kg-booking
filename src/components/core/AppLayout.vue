...
<template>
  <div class="min-h-screen bg-slate-100 flex items-center justify-center font-sans text-slate-800">
    <div id="app-root" class="w-full max-w-[480px] lg:max-w-[1000px] xl:max-w-[1280px] h-full max-h-[100dvh] md:h-[95vh] md:max-h-[auto] md:rounded-[2rem] md:shadow-2xl flex flex-col relative overflow-hidden bg-white border border-slate-200 transition-all duration-300" v-cloak>
