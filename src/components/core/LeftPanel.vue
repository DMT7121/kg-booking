...
<template>
  ...
  >
    ...
    <!-- TABS -->
    <div class="flex flex-nowrap overflow-x-auto w-full bg-white text-[10px] font-black border-b border-slate-100 uppercase tracking-widest shadow-sm relative z-10 no-scrollbar">
