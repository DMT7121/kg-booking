-- ===================================================
-- COMBINED MIGRATION SCRIPT FOR SUPABASE POSTGRESQL
-- Project: KING'S GRILL OmniBooking AI
-- ===================================================
...
CREATE POLICY "customer_all_policy" ON customers FOR ALL TO authenticated, anon USING (TRUE) WITH CHECK (TRUE);
CREATE POLICY "bookings_all_policy" ON bookings FOR ALL TO authenticated, anon USING (TRUE) WITH CHECK (TRUE);
CREATE POLICY "menu_items_all_policy" ON menu_items FOR ALL TO authenticated, anon USING (TRUE) WITH CHECK (TRUE);
CREATE POLICY "corrections_all_policy" ON booking_corrections FOR ALL TO authenticated, anon USING (TRUE) WITH CHECK (TRUE);
CREATE POLICY "ai_usage_all_policy" ON ai_usage_logs FOR ALL TO authenticated, anon USING (TRUE) WITH CHECK (TRUE);
CREATE POLICY "audit_logs_all_policy" ON audit_logs FOR ALL TO authenticated, anon USING (TRUE) WITH CHECK (TRUE);
